...
return [
    'modules' => [
        ...
        'Elightwalk_AmastyGiftCard' => 1,
        'Elightwalk_AttributeGroup' => 1,
        'Elightwalk_CatalogSearch' => 1,
        'Elightwalk_Core' => 1,
