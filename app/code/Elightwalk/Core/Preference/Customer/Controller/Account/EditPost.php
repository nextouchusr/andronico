...
namespace Elightwalk\Core\Preference\Customer\Controller\Account;

use Magento\Customer\Controller\Account\EditPost as MagentoEditPost;
...
class EditPost extends MagentoEditPost implements CsrfAwareActionInterface, HttpPostActionInterface
{
    /**
    ...
    private function populateNewCustomerDataObject(
        ...
        if ($inputData->getParam('dob')) {
            $customerDto->setDob($inputData->getParam('dob'));
        } else {
            $customerDto->setDob('');
        }
