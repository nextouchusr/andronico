...
class AddLimitedTrafficZoneAttribute implements DataPatchInterface
{
    ...
    public function apply(): self
    {
        ...
        $customerSetup->addAttribute(
            ...
            AddressInterface::LIMITED_TRAFFIC_ZONE,
            [
                'type' => 'int',
                'label' => 'Limited Traffic Zone',
                'input' => 'boolean',
        ...
        $attribute = $customerSetup
            ->getEavConfig()
            ->getAttribute(AddressMetadataInterface::ENTITY_TYPE_ADDRESS, AddressInterface::LIMITED_TRAFFIC_ZONE)
            ->addData([
