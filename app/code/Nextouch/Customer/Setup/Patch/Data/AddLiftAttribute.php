...
class AddLiftAttribute implements DataPatchInterface
{
    ...
    public function apply(): self
    {
        ...
        $attribute = $customerSetup
            ->getEavConfig()
            ->getAttribute(AddressMetadataInterface::ENTITY_TYPE_ADDRESS, AddressInterface::LIFT)
            ->addData([
