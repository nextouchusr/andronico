...
class AddFiscalCodeAttribute implements DataPatchInterface
{
    ...
    public function apply(): self
    {
        ...
        $attribute = $customerSetup
            ->getEavConfig()
            ->getAttribute(AddressMetadataInterface::ENTITY_TYPE_ADDRESS, AddressInterface::FISCAL_CODE)
            ->addData([
