...
class Info extends Generic implements TabInterface
{
   ...
   /**
    ...
    protected function _prepareForm()
    {
		...
		$legendNotes .= '<br>';
		$legendNotes .= '<span style="font-size:10px;">A free extension by Customer Paradigm.  Call 303-473-4400 or <a href="http://www.customerparadigm.com">www.customerparadigm.com</a></span>';
